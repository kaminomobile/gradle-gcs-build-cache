...
buildscript {
    ...
    dependencies {
        classpath 'si.kamino:gradle-gcs-build-cache:1.0.0'
    }
}

apply plugin: 'si.kamino.gradle-gcs-build-cache'
...
buildscript {
    ...
    dependencies {
        classpath 'si.kamino:gradle-gcs-build-cache:1.0.1'
    }
}

import si.kamino.gradle.caching.GCSBuildCache
import si.kamino.gradle.caching.GCSBuildCacheServiceFactory
